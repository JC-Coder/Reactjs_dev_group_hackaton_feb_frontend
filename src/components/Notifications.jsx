...
export default function Notifications({
  ...
  return (
    <aside
      className={`glass-effect fixed p-4 top-0 right-0 h-screen z-50 w-[55vw] sm:w-[45vw] md:w-[35vw] transition ${
    ...
    >
      <div>
        <XCircleIcon
          ...
          className="my-1 h-9 w-9 text-gray-500 hover:text-red-500 cursor-pointer relative left-[90%]"
        />
      </div>
